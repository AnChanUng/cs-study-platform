...
// Generated: 2026-04-04T10:54:36.565Z
...
export const hardcodedQuestions = [
  ...
  },
  {
    "id": 56,
    "title": "변수와 스레드",
    "content": "변수에서 code 영역의 역할과, 스레드가 독립적으로 가지는 것과 공유하는 것을 설명해주세요.",
    "answer": "### 변수\n- **code** : 실행할 프로그램 코드\n\n### 스레드\n**스레드가 독립적으로 가지는 것:**\n- stack\n- PC (Program Counter)\n- 레지스터\n\n**스레드가 공유하는 것:**\n- heap\n- data\n- code",
    "difficulty": "BASIC",
    "tags": "변수, code, 스레드, stack, PC, 레지스터, heap, data",
    "categorySlug": "major-exam",
    "categoryName": "전공필기",
    "categoryId": 11,
    "studyCount": 0,
    "bookmarked": false
